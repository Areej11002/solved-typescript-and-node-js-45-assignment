...
console.log (`Eric ${firstName},"would you like to learn some python today?"`);
...
let quote = "setting goals is the first step in turning the invisble into the visible"
...
let names : string [] = ["zara","hamza","zaheem","imran"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let Names : string [] = ["zara","hamza","zaheem","areeba"];
...
let guestArr : string [] = ["zara","hamza","zaheem"];
...
let GuestArr : string [] = ["zara","hamza","zaheem","azib"];
let CanNotAttend : string = "azib";
...
GuestArr.map((items) =>
console.log(`Dear ${items}, you are inivited to the diner`)
);
...
console.log(guesTArr);
guesTArr.map((items) =>
(console.log(`Dear ${items} , i found a bigger dinner table so I am inivitad more peoples.`)));

//Part 2 Beginning • Add one new guest to the beginning of your array.

let guestBeg : string = "nabeel";
...
let guests : string [] = ["hamza","zaheem","ali","nabeel","bilal"];
...
let placesTovisit: string [] = ["Pakistan","Korea","Japan","America","londan"];
...
let country: string [] = ["pakistan","korea","japan","america","england"];
...
let person: {name: string, fname: string, age: number} = {name: "areej", fname: "female", age: "18"}
console.log(person);
...
let name_1 : string = "zara";
let name_2 : string = "zara shah";
let name_3 : string = "zarkook";
...
let Country : string [] =["pakistan","south korea","china","japan"];
if ("country.includes"){
...
let user : string [] = ["eric","haseeb","fatima","ali","admin"]
...
console.log("\n")
for (let pizza of favourite_pizza) {
    console.log(` I really like ${pizza} pizzal`)
}
console.log("\nI really love pizza!")
...
let album = makeAlbum("raees" ,"Red wave")
console.log(album)
...
const magicians3: string[] = ["usman","wahaj","haseeb"];
